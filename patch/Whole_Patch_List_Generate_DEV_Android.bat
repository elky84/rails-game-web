...
REM @@@ Making BG @@@
ruby -I "../../../GundamBase/SazabiExcel" "../../../GundamBase/SazabiExcel/ExcelReader.rb" "BG_list.xlsx" "BG_LIST" "INDEX" "json:patchdata" "" "Android"
...
REM @@@ Making Effect @@@
ruby -I "../../../GundamBase/SazabiExcel" "../../../GundamBase/SazabiExcel/ExcelReader.rb" "effect_list.xlsx" "EFFECT_LIST" "INDEX" "json:patchdata" "" "Android"
IF %errorlevel% NEQ 0 GOTO :error
...
REM  @@@ Makeing Sound @@@
ruby -I "../../../GundamBase/SazabiExcel" "../../../GundamBase/SazabiExcel/ExcelReader.rb" "sound_list.xlsx" "SOUND_LIST" "INDEX" "json:patchdata" "../../program" "Android"
IF %errorlevel% NEQ 0 GOTO :error
