...
namespace rails_post_tool
{
    public partial class Form : System.Windows.Forms.Form
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            ExecuteCommandSync("ruby -I ../../../../GundamBase/SazabiExcel ../../../../GundamBase/SazabiExcel/ExcelReader.rb data/EXCEL_LIST.xlsx EXCEL_LIST INDEX json:file " + AppDomain.CurrentDomain.BaseDirectory + "data");
        ...
        void execute_async(string file, string excel, string dest, string index, string address)
        {
            ...
            string cmd = "ruby -I ../../../../GundamBase/SazabiExcel ../../../../GundamBase/SazabiExcel/ExcelReader.rb " + dest + file + ".xlsx " + excel + " " + index + " rails_post:" + address;
