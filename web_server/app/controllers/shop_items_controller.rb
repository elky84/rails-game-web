class ShopItemsController < ApplicationController
  ...
  def create
    @shop_item = create_or_update(:SHOP_ITEM_ID)
  ...
  private
    ...
    def shop_item_params
      params.require(:shop_item).permit(:SHOP_ITEM_ID, :HIDE, :GIFT, :STORE, :ICON, :PRICE_TYPE, :CHARACTER_LEVEL, :PRICE, :SHOP_CATEGORY, :CAPACITY, :ITEM_ID, :GACHA, :BONUS_STRING, :BONUS_ID, :NAME, :EXPLAIN, :START_DATE, :END_DATE, :NSTORE_PID, :PLAY_PID)
    end
end
