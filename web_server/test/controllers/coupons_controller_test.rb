...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { COUPON_INDEX: @coupon.COUPON_INDEX, COUPON_STRING: @coupon.COUPON_STRING, REWARD: @coupon.REWARD }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { COUPON_INDEX: @coupon.COUPON_INDEX, COUPON_STRING: @coupon.COUPON_STRING, REWARD: @coupon.REWARD }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
